...
export default function AboutPage() {
  ...
  const timelineData = [
    { year: "2010", title: "Studio Launch", description: "Gooner's Studio was born with a vision to create groundbreaking digital experiences." },
  ...
  const testimonials = [
    { 
      text: "Gooner's Studio transformed our brand with their exceptional creative vision. Their ability to blend artistry with technology is unmatched in the industry.", 
    ...
    { 
      text: "Working with Gooner's Studio was transformative. They don't just create content; they craft experiences that leave lasting impressions.", 
  ...
  const timelineEvents = [
    { year: "2010", description: "Gooner's Studio was founded with a vision to create innovative digital experiences." },
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Gooner's Studio was entrusted with transforming a major industry conference into a high-impact hybrid event. We handled the AV production, live streaming to a global audience, and created engaging video content. Our team ensured both in-person and virtual attendees had an exceptional experience.",
    ...
    },
    {
      ...
      description: "Gooner's Studio partnered with Bloom Cosmetics to launch their new line of organic skincare products. We produced a series of visually stunning videos and developed a targeted social media campaign to generate buzz. By leveraging influencer marketing, we created high-impact content that resonated with their target audience.",
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl z-10">
          <div className="text-center">
            ...
            >
              At Gooner's Studio, we transform ideas into captivating digital experiences. Our passion for creativity drives us to push boundaries and redefine what&apos;s possible in the digital realm.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
            ...
            >
              ...
              <p className="text-center md:max-w-md mx-auto text-muted-foreground">
                Innovation, Excellence, Integrity, Collaboration, and Client Success guide everything we do at Gooner's Studio.
              </p>
            </motion.div>
          </div>
        </div>
